...
T3_TL = PO.PhysicalObject("rectangle", [OF.ObjectFeature("yellow", "color")], "TL")
T3_TR = PO.PhysicalObject("triangle", [OF.ObjectFeature("green", "color")], "TR")
T3_BL = PO.PhysicalObject("triangle", [OF.ObjectFeature("blue", "color")], "BL")
...
T3_TR = PO.PhysicalObject("rectangle", [OF.ObjectFeature("green", "color")], "TR")
T3_BL = PO.PhysicalObject("square", [OF.ObjectFeature("red", "color")], "BL")
T3_BR = PO.PhysicalObject("circle", [OF.ObjectFeature("yellow", "color")], "BR")
World_T3 = VW.VisualWorld([T3_TL, T3_TR, T3_BL, T3_BR])
MyListener.ChangeVisualWorld(World_T3)
MyListener.Infer(T3_Utterance)
T3Res = MyListener.ComputePosterior(2)
